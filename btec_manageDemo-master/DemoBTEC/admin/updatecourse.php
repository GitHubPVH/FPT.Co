        ...
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-header">
                    <a href="addnewcourse.php"> + Update to this course</a>
                    <?php 
                        $ID = $_REQUEST['ID'];
                     ?>
                </h5>
                ...
                <div id="hide-table">
                    ...
                    <input type="submit" name="btnSearch" value="Search">                   
                        ...
                        <?php 
                            $query = "SELECT * FROM tblCourse WHERE _idCourse = '".$ID."'";
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
                        <thead>
                            <tr role="row">
                                 <th class="col-lg-1 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Class: activate to sort column ascending"   style="width: 50px;">ID
                                     
                                </th>

                                <th class="col-lg-2 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Class: activate to sort column ascending" style="width: 160px;">Topic

                                    
                                </th>

                                <th class="col-lg-2 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Class Numeric: activate to sort column ascending" style="width: 160px;">
                                Category
                                    
                                </th>

                                <th class="col-lg-3 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Teacher Name: activate to sort column ascending" style="width: 249px;">
                                Start Date
                                ...
                                <th class="col-lg-2 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Note: activate to sort column ascending" style="width: 160px;">End Date
                                    
                                </th>

                                <th class="col-lg-1 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 160px;">Trainer
                                    
                                </th>

                                <th class="col-lg-1 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 200px;">Content
                                    
                                </th>
                            </tr>
                            <tr>
                                <td>
                                    <input type="text" value="<?=$rows['_idCourse']?>" name = "ID">
                                </td>
                                <td>
                                ...
                                <td>
                                    <select name="selectCategory" class="browser-default custom-select mb-4">
                                            <?php 
                                                $categoryQuery = "SELECT _type FROM tblcategory ";
                                                $categoryResult = mysqli_query($conn,$categoryQuery) or die(mysqli_error());
                                                while ($categoryRow = mysqli_fetch_assoc($categoryResult)) {
                                                  ?>
                                                  <option placeholder = "abc" value="<?=$categoryRow['_idCategory'];?>"><?=$categoryRow["_type"];?></option>
                                                  <?php
                                                }
                                             ?>
                                         </select>
                                ...
                                <td>
                                    <input type="date" name="txtStartDate" value="<?=$rows['_startDate']?>">
                                </td>
                                <td>
                                    <input type="date" name="txtEndDate" value="<?=$rows['_endDate']?>">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="text" name="txtContent" value="<?=$rows['_content']?>">
                                </td>
                            </tr>
                     ...
                     <?php 
                        if (isset($_REQUEST['btnUpdate'])) {
                            ...
                            $newStartDate = $_POST["txtStartDate"];
                            $newEndDate = $_POST["txtEndDate"];
                            $newContent = stripcslashes($_POST['txtContent']);
                            $newContent = mysqli_real_escape_string($conn,$newContent);

                            $query = "UPDATE tblCourse SET _startDate = '".$newStartDate."',_endDate ='".$newEndDate."',
                            _content = '".$newContent."' WHERE _idCourse = '".$ID."'";
                            $result = mysqli_query($conn,$query) or die (mysqli_error($conn));
                            if ($result) {
                                ?>
                                <script>alert("Update Successful");
                                    location.assign("http://localhost:8012/btec_manageDemo-master/DemoBTEC/admin/viewcourse.php");
                                </script>
                                <?php
                                ...
                                location.assign("http://localhost:8012/btec_manageDemo-master/DemoBTEC/admin/updatecourse.php");
                                </script>
                                <?php
                            } 
                        }
