                ...
                <?php 
                    ...
                    while ($rows = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td><?=$rows["_content"]?></td>
                            <td>
                                 <a href="http://localhost:8012/btec_manageDemo-master/DemoBTEC/admin/removecourse.php?ID=<?=$rows['_idCourse']?>" class="btn btn-danger btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="Edit">View Course</a>
                             </td>
